...
- (void)reloadTrackItems {
    ...
    UIView *header = [[[UIView alloc] initWithFrame:CGRectMake(0, 0, self.tableView.bounds.size.width, 40)] autorelease];
    ...
    shuffle.frame = CGRectMake(MAX(15.0f, header.bounds.size.width - 90.0f), 3, 75, 34);
